    ...
    <>
      ...
      <section className="-mt-32 bg-gray-200 px-4 pb-10 pt-4">
        <div className="container mx-auto">
          ...
          <div
            id="about-us"
            className="mt-20 flex flex-wrap items-center pb-0"
          >
      ...
      <section className="relative h-full w-full bg-[url('/img/bg.png')] bg-cover bg-center py-8 px-4 pb-0 ">
        <div className="container mx-auto">
          ...
          <div className="mb-15 mx-auto mt-0 mb-0 max-w-6xl bg-gray-100 px-0 pb-0 ">
            <Carousel />
          </div>
        </div>
      </section>
      <section className="h-auto bg-white mx-5 px-6 pt-5 pb-5 align-middle">
        <div className="container mx-auto">
        <PageTitle
              heading="Our"
              span2="Partners"
