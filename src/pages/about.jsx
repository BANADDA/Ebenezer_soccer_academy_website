...
// import { aboutData, teamData, contactData } from "@/data";
    ...
    <>
      ...
      <section className="-mt-32 bg-gray-200 px-4 pb-20 pt-20">
        <div className="container mx-auto">
          ...
          <div className="mb-5 mt-5 ml-10 mr-10 flex flex-col rounded-xl bg-white bg-clip-border shadow-none">
            <div className="flex">
              <div className="w-1/3">
                <img
                  class=" h-4/5w-full rounded-l-lg object-cover"
                  src="/img/ball.jpg"
                  alt="card image"
                />
              </div>
              <div class="text-secondary w-2/3 p-6">
                <span class="font-bold uppercase text-blue-gray-700">
                  Our Objectives
                </span>
                <ul className="my-10 max-w-md  space-y-1 text-gray-500 dark:text-gray-400">
